...
class Bebida(Producto):
    ...
    def a_diccionario(self) -> Dict[str, Any]:
        """
        Convierte el objeto Bebida a un diccionario para ser almacenado en JSON.
        Incluye los campos específicos de Bebida además de los heredados.
        """
